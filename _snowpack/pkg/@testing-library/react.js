...
import { r as react, o as objectAssign$1 } from '../common/index-04edb6a1.js';
import { r as reactDom, s as scheduler } from '../common/index-09ea300a.js';
  ...
  _export({ target: 'JSON', stat: true, forced: FORCED_JSON_STRINGIFY }, {
    ...
    stringify: function stringify(it, replacer, space) {
      ...
      if (!isArray(replacer)) replacer = function (key, value) {
        if (isCallable$1($replacer)) value = functionCall($replacer, this, key, value);
...
var entries$2 = function (it) {
  ...
  return it === ArrayPrototype$3 || (objectIsPrototypeOf(ArrayPrototype$3, it) && own === ArrayPrototype$3.entries)
    || hasOwnProperty_1(DOMIterables$1, classof(it)) ? entries$1 : own;
};
...
var find$1 = function (it) {
  var own = it.find;
  return it === ArrayPrototype$4 || (objectIsPrototypeOf(ArrayPrototype$4, it) && own === ArrayPrototype$4.find) ? find : own;
};
...
var concat$2 = function (it) {
  var own = it.concat;
  return it === ArrayPrototype$5 || (objectIsPrototypeOf(ArrayPrototype$5, it) && own === ArrayPrototype$5.concat) ? concat$1 : own;
};
...
var keys$6 = function (it) {
  var own = it.keys;
  return it === ArrayPrototype$6 || (objectIsPrototypeOf(ArrayPrototype$6, it) && own === ArrayPrototype$6.keys)
    || hasOwnProperty_1(DOMIterables$2, classof(it)) ? keys$5 : own;
};
...
var _entries = interopRequireDefault(entries$3);

var _find = interopRequireDefault(find$3);

var _stringify = interopRequireDefault(stringify$2);

var _concat = interopRequireDefault(concat$4);
...
var na=objectAssign$1({},z,{key:function(a){if(a.key){var b=ja[a.key]||a.key;if("Unidentified"!==b)return b}return "keypress"===a.type?(a=u(a),13===a?"Enter":String.fromCharCode(a)):"keydown"===a.type||"keyup"===a.type?ka[a.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:D,charCode:function(a){return "keypress"===a.type?u(a):0},keyCode:function(a){return "keydown"===a.type||"keyup"===a.type?a.keyCode:0},which:function(a){return "keypress"===
a.type?u(a):"keydown"===a.type||"keyup"===a.type?a.keyCode:0}});x(na);var oa=objectAssign$1({},E,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0});x(oa);var pa=objectAssign$1({},z,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:D});x(pa);var qa=objectAssign$1({},y,{propertyName:0,elapsedTime:0,pseudoElement:0});x(qa);
var ra=objectAssign$1({},E,{deltaX:function(a){return "deltaX"in a?a.deltaX:"wheelDeltaX"in a?-a.wheelDeltaX:0},deltaY:function(a){return "deltaY"in a?a.deltaY:"wheelDeltaY"in a?-a.wheelDeltaY:"wheelDelta"in a?-a.wheelDelta:0},deltaZ:0,deltaMode:0});x(ra);var F=null;function G(a){if(null===F)try{var b=("require"+Math.random()).slice(0,7);F=(module&&module[b]).call(module,"timers").setImmediate;}catch(c){F=function(a){var b=new MessageChannel;b.port1.onmessage=a;b.port2.postMessage(void 0);};}return F(a)}
var H=reactDom.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events,sa=H[5],I=H[6],ta=reactDom.unstable_batchedUpdates,J=q.IsSomeRendererActing,K="function"===typeof scheduler.unstable_flushAllWithoutAsserting,L=scheduler.unstable_flushAllWithoutAsserting||function(){for(var a=!1;sa();)a=!0;return a};function M(a){try{L(),G(function(){L()?M(a):a();});}catch(b){a(b);}}var N=0,ua=!1,O=reactDom.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events[6],va=reactDom.unstable_batchedUpdates,Q=q.IsSomeRendererActing;
...
function Aa(a,b,c,d,e,g,f,k,ca){za.apply(this,arguments);if(R){if(R){var P=S;R=!1;S=null;}else throw Error(p(198));T||(T=!0,U=P);}}var V=reactDom.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events,Ba=V[0],Ca=V[1],Da=V[2],Ea=V[3],Fa=V[4];function Ha(){}
...
function Ua(a){return function(b,c){if(react.isValidElement(b))throw Error(p(228));if(Y(b))throw Error(p(229));var d="on"+a[0].toUpperCase()+a.slice(1),e=new Ha;e.target=b;e.type=a.toLowerCase();var g=Ba(b),f=new ba(d,e.type,g,e,b);f.persist();objectAssign$1(f,c);Ta.has(a)?f&&f._reactName&&Qa(f._targetInst,null,f):f&&f._reactName&&Oa(f._targetInst,Ra,f);reactDom.unstable_batchedUpdates(function(){Ea(b);if(f){var a=f._dispatchListeners,c=f._dispatchInstances;if(Array.isArray(a))for(var d=0;d<a.length&&!f.isPropagationStopped();d++)Na(f,
...
exports.isDOMComponent=X;exports.isDOMComponentElement=function(a){return !!(a&&react.isValidElement(a)&&a.tagName)};exports.isElement=function(a){return react.isValidElement(a)};exports.isElementOfType=function(a,b){return react.isValidElement(a)&&a.type===b};exports.mockComponent=function(a,b){b=b||a.mockTagName||"div";a.prototype.render.mockImplementation(function(){return react.createElement(b,null,this.props.children)});return this};exports.nativeTouchData=function(a,b){return {touches:[{pageX:a,pageY:b}]}};
exports.renderIntoDocument=function(a){var b=document.createElement("div");return reactDom.render(a,b)};exports.scryRenderedComponentsWithType=Ma;exports.scryRenderedDOMComponentsWithClass=Ka;exports.scryRenderedDOMComponentsWithTag=La;exports.traverseTwoPhase=Oa;
